...
function smeniGolemina1() {
    var sekcii = document.getElementsByTagName('section');
    for(var i = 0; i < sekcii.length; i ++)
    {
        sekcii[i].style.fontSize = "1em";
    }
}

function smeniGolemina2() {
    var sekcii = document.getElementsByTagName('section');
    for(var i = 0; i < sekcii.length; i ++)
    {
        sekcii[i].style.fontSize = "1.25em";
    }
}
function smeniGolemina3() {
    var sekcii = document.getElementsByTagName('section');
    for(var i = 0; i < sekcii.length; i ++)
    {
        sekcii[i].style.fontSize = "1.5em";
    }
}
